...
public class ControlsUI extends JFrame {
    ...
    private JLabel labelGeneralAutomaticNextGenerations;
    private JLabel labelGeneralField;
    private JLabel labelGeneralPatterns;
    ...
    public ControlsUI() {
        ...
        Dimension minimumDimension = new Dimension(300, 420);
    ...
    private void initUI() {
        ...
        labelGeneralAutomaticNextGenerations = new JLabel("<html><b>Automatic next generations</b></html>");
        labelGeneralField = new JLabel("<html><b>Field</b></html>");
        labelGeneralPatterns = new JLabel("<html><b>Patterns</b></html>");
        ...
        c.gridx = 0;
        c.gridy = currY++;
        panelMain.add(new JSeparator(SwingConstants.HORIZONTAL), c);

        c.weightx = 0.1;
        c.gridwidth = 3;
        c.gridx = 0;
        c.gridy = currY++;
        panelMain.add(labelGeneralAutomaticNextGenerations, c);
        ...
        c.gridx = 0;
        c.gridy = currY++;
        panelMain.add(labelGeneralField, c);
        ...
        c.gridx = 0;
        c.gridy = currY++;
        panelMain.add(labelGeneralPatterns, c);
